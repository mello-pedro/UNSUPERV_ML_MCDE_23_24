...
**O código fonte em R do presente trabalho consta ao link do reposiório a seguir: [Repositório GitHub](https://github.com/mello-pedro/UNSUPERV_ML_MCDE_23_24/blob/main/wines_analysis.qmd).**
